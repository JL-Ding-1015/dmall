package com.djl.dmall.admin.utils;
...
public class JwtTokenUtil {
    ...
    @Value("${dmall.jwt.secret}")
    private String secret;
    @Value("${dmall.jwt.expiration}")
    private Long expiration;
    /*private String secret = "aabbccdd";
    private Long expiration = 1234567890L;*/
