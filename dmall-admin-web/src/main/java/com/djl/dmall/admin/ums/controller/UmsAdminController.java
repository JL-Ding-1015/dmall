...
import com.djl.dmall.admin.ums.vo.UmsAdminLoginParam;
import com.djl.dmall.admin.ums.vo.UmsAdminParam;
import com.djl.dmall.admin.utils.JwtTokenUtil;
...
public class UmsAdminController {
    ...
    @Value("${dmall.jwt.tokenHeader}")
    private String tokenHeader;
    @Value("${dmall.jwt.tokenHead}")
