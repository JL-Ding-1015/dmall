...
import com.djl.dmall.vo.product.PmsBrandParam;
...
public class PmsBrandController {
    ...
    public Object getList(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        PageInfoVo resPageVo = brandService.brandPageInfo(keyword, pageNum, pageSize);

        return commonResult.success(resPageVo);
    }
